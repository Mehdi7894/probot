...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('day')) {
    ...
    profile[message.author.id].credits += 22222222265555595
     message.channel.send(`**${message.author.username} you collect your \`22222222265555595\` :dollar: daily pounds**`)
} else {
